package com.example.keval.e_moss.Aadhaar.FingerPrint;
...
public class FingerPrintView extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.finger_print_view);

        TextView mHeadingLabel = (TextView) findViewById(R.id.headingLabel);
        ImageView mFingerprintImage = (ImageView) findViewById(R.id.fingerprintImage);
